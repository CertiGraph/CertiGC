...
Definition f_certicoq_gc__funs_init := {|
  fn_return := tvoid;
  fn_callconv := cc_default;
  fn_params := ((_out, (tptr (Tstruct __463 noattr))) :: nil);
  fn_vars := nil;
  fn_temps := nil;
  fn_body :=
(Ssequence
  (Sassign
    (Efield
      (Ederef (Etempvar _out (tptr (Tstruct __463 noattr)))
        (Tstruct __463 noattr)) _gc_abort
  ...
  (Ssequence
    (Sassign
      (Efield
        (Ederef (Etempvar _out (tptr (Tstruct __463 noattr)))
          (Tstruct __463 noattr)) _gc_block__header_get_ptr
    ...
    (Ssequence
      (Sassign
        (Efield
          (Ederef (Etempvar _out (tptr (Tstruct __463 noattr)))
            (Tstruct __463 noattr)) _gc_block__copy
          (tptr (Tfunction
      ...
      (Ssequence
        (Sassign
          (Efield
            (Ederef (Etempvar _out (tptr (Tstruct __463 noattr)))
              (Tstruct __463 noattr)) _gc_block__ptr_iter
            (tptr (Tfunction
                    (Tcons (tptr (talignas 2%N (tptr tvoid)))
                      (Tcons
                        (tptr (Tfunction
        ...
        (Ssequence
          (Sassign
            (Efield
              (Ederef (Etempvar _out (tptr (Tstruct __463 noattr)))
                (Tstruct __463 noattr)) _gc_block__of_header
          ...
          (Sassign
            (Efield
              (Ederef (Etempvar _out (tptr (Tstruct __463 noattr)))
                (Tstruct __463 noattr)) _gc_block__size_get
...
Definition f_certicoq_gc__garbage_collect := {|
  ...
  fn_vars := ((_gc_funs, (Tstruct __463 noattr)) :: nil);
  fn_temps := nil;
  fn_body :=
(Ssequence
  (Scall None
    (Evar _certicoq_gc__funs_init (Tfunction
                                    (Tcons (tptr (Tstruct __463 noattr))
                                      Tnil) tvoid cc_default))
    ((Eaddrof (Evar _gc_funs (Tstruct __463 noattr))
       (tptr (Tstruct __463 noattr))) :: nil))
  (Scall None
                             ...
                             (Tcons (tptr (Tstruct __463 noattr))
                               (Tcons (tptr tuint)
                                 (Tcons (tptr (Tstruct _thread_info noattr))
                                   Tnil))) tvoid cc_default))
    ((Eaddrof (Evar _gc_funs (Tstruct __463 noattr))
       (tptr (Tstruct __463 noattr))) :: (Etempvar _fi (tptr tuint)) ::
...
((___builtin_ais_annot,
 ...
 (_garbage_collect,
   Gfun(External (EF_external "garbage_collect"
                   (mksignature (AST.Tint :: AST.Tint :: AST.Tint :: nil)
                     AST.Tvoid cc_default))
     (Tcons (tptr (Tstruct __463 noattr))
       (Tcons (tptr tuint) (Tcons (tptr (Tstruct _thread_info noattr)) Tnil)))
     tvoid cc_default)) ::
 (_free_heap,
 ...
 (_certicoq_gc__reset_heap, Gfun(Internal f_certicoq_gc__reset_heap)) :: nil).

Definition public_idents : list ident :=
(_certicoq_gc__reset_heap :: _certicoq_gc__free_heap ::
 _certicoq_gc__garbage_collect :: _certicoq_gc__make_tinfo ::
 _certicoq_gc__cell_modify :: _certicoq_gc__funs_init ::
 _certicoq_gc__abort :: _remember :: _reset_heap :: _free_heap ::
 _garbage_collect :: _make_tinfo :: _certicoq_block__field_ptr_iter ::
...
(*\nInput hashes (sha256):\n\ned4ba73dc6acd98c42798600c332b05d2c10fa7a5db5657799573d52c4929421  src/c/include/coq-vsu-gc/src/certicoq_gc.c
ce236f1d0280dc25041c38f4edaf561594832ce94e09e849144ca9b81ffa46a6  src/c/include/coq-vsu-gc/certicoq_gc.h
