...
Definition f_forward := {|
  ...
  fn_vars := ((_f_args__1, (Tstruct __368 noattr)) :: nil);
  fn_temps := ((_args, (tptr (Tstruct __368 noattr))) ::
               ...
               (_va, (talignas 2%N (tptr tvoid))) :: (_hd, (tptr tuint)) ::
               (_sz, tuint) :: (_new, (tptr (talignas 2%N (tptr tvoid)))) ::
               ...
               (_t'10, (tptr (talignas 2%N (tptr tvoid)))) :: nil);
  fn_body :=
(Ssequence
  (Sset _args
    (Ecast (Etempvar _f_args (tptr tvoid)) (tptr (Tstruct __368 noattr))))
  (Ssequence
    (Sset _from_start
      (Efield
        (Ederef (Etempvar _args (tptr (Tstruct __368 noattr)))
          (Tstruct __368 noattr)) _from_start
        (tptr (talignas 2%N (tptr tvoid)))))
    (Ssequence
      (Sset _from_limit
        (Efield
          (Ederef (Etempvar _args (tptr (Tstruct __368 noattr)))
            (Tstruct __368 noattr)) _from_limit
          (tptr (talignas 2%N (tptr tvoid)))))
      (Ssequence
        (Sset _next
          (Efield
            (Ederef (Etempvar _args (tptr (Tstruct __368 noattr)))
              (Tstruct __368 noattr)) _next
            (tptr (tptr (talignas 2%N (tptr tvoid))))))
        (Ssequence
          (Sset _depth
            (Efield
              (Ederef (Etempvar _args (tptr (Tstruct __368 noattr)))
                (Tstruct __368 noattr)) _depth tint))
          (Ssequence
            (Sset _va
                                    ...
                                    (Ssequence
                                      ...
                                      (Sifthenelse (Ebinop Ogt
                                        ...
                                        (Ssequence
                                          (Sassign
                                            (Efield
                                              (Evar _f_args__1 (Tstruct __368 noattr))
                                              _from_start
                                              (tptr (talignas 2%N (tptr tvoid))))
                                            (Etempvar _from_start (tptr (talignas 2%N (tptr tvoid)))))
                                          (Ssequence
...
Definition f_forward_roots := {|
  ...
  fn_vars := ((_f_args, (Tstruct __368 noattr)) :: nil);
      ...
      (Ssequence
        ...
        (Sloop
          (Ssequence
            ...
            (Ssequence
              (Sassign
                (Efield (Evar _f_args (Tstruct __368 noattr)) _from_start
                  (tptr (talignas 2%N (tptr tvoid))))
                (Etempvar _from_start (tptr (talignas 2%N (tptr tvoid)))))
              (Ssequence
                (Sassign
                  (Efield (Evar _f_args (Tstruct __368 noattr)) _from_limit
                    (tptr (talignas 2%N (tptr tvoid))))
                  (Etempvar _from_limit (tptr (talignas 2%N (tptr tvoid)))))
                (Ssequence
                  (Sassign
                    (Efield (Evar _f_args (Tstruct __368 noattr)) _next
                      (tptr (tptr (talignas 2%N (tptr tvoid)))))
                    (Etempvar _next (tptr (tptr (talignas 2%N (tptr tvoid))))))
                  (Ssequence
                    (Sassign
                      (Efield (Evar _f_args (Tstruct __368 noattr)) _depth
                    ...
                    (Ssequence
                      ...
                      (Scall None
                        ...
                        ((Eaddrof (Evar _f_args (Tstruct __368 noattr))
                           (tptr (Tstruct __368 noattr))) ::
                         (Ebinop Oadd
...
Definition f_cell_modify := {|
  ...
  fn_vars := nil;
  fn_temps := ((_t'2, tint) :: (_t'1, (tptr (talignas 2%N (tptr tvoid)))) ::
               (_t'6, (tptr (talignas 2%N (tptr tvoid)))) ::
               (_t'5, (tptr (talignas 2%N (tptr tvoid)))) ::
