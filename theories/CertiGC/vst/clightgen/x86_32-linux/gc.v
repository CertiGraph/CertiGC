...
(Ssequence
  ...
  (Ssequence
    (Scall (Some _t'1)
      ...
      ((Etempvar _new (tptr (talignas 2%N (tptr tvoid)))) :: nil))
    (Sassign
      (Ederef
        (Ebinop Oadd (Etempvar _old (tptr (talignas 2%N (tptr tvoid))))
          (Econst_int (Int.repr 0) tint) (tptr (talignas 2%N (tptr tvoid))))
...
Definition f_forward := {|
  ...
  fn_vars := ((_f_args__1, (Tstruct __383 noattr)) :: nil);
  fn_temps := ((_args, (tptr (Tstruct __383 noattr))) ::
               (_gc_funs, (tptr (Tstruct __344 noattr))) ::
               ...
               (_new, (tptr (talignas 2%N (tptr tvoid)))) :: (_t'8, tint) ::
               (_t'7, tint) :: (_t'6, (talignas 2%N (tptr tvoid))) ::
               (_t'5, (tptr (talignas 2%N (tptr tvoid)))) :: (_t'4, tuint) ::
               (_t'3, (tptr tuint)) :: (_t'2, (talignas 2%N (tptr tvoid))) ::
               (_t'1, (tptr tvoid)) ::
               (_t'15, (talignas 2%N (tptr tvoid))) ::
               (_t'14,
                (tptr (Tfunction
...
(Ssequence
  (Sset _args
    (Ecast (Etempvar _f_args (tptr tvoid)) (tptr (Tstruct __383 noattr))))
  (Ssequence
    (Sset _gc_funs
      (Efield
        (Ederef (Etempvar _args (tptr (Tstruct __383 noattr)))
          (Tstruct __383 noattr)) _gc_funs (tptr (Tstruct __344 noattr))))
    (Ssequence
      (Sset _from_start
        (Efield
          (Ederef (Etempvar _args (tptr (Tstruct __383 noattr)))
            (Tstruct __383 noattr)) _from_start
          (tptr (talignas 2%N (tptr tvoid)))))
      (Ssequence
        (Sset _from_limit
          (Efield
            (Ederef (Etempvar _args (tptr (Tstruct __383 noattr)))
              (Tstruct __383 noattr)) _from_limit
            (tptr (talignas 2%N (tptr tvoid)))))
        (Ssequence
          (Sset _next
            (Efield
              (Ederef (Etempvar _args (tptr (Tstruct __383 noattr)))
                (Tstruct __383 noattr)) _next
              (tptr (tptr (talignas 2%N (tptr tvoid))))))
          (Ssequence
            (Sset _depth
              (Efield
                (Ederef (Etempvar _args (tptr (Tstruct __383 noattr)))
                  (Tstruct __383 noattr)) _depth tint))
            (Ssequence
              (Ssequence
                (Ssequence
                  (Sset _t'15
                  ...
                  (Scall (Some _t'1)
                    (Evar _int_or_ptr__to_ptr (Tfunction
                                                (Tcons
                                                  ...
                                                  Tnil) (tptr tvoid)
                                                cc_default))
                    ((Etempvar _t'15 (talignas 2%N (tptr tvoid))) :: nil)))
                (Sset _v
                        ...
                        (Ssequence
                          (Ssequence
                            (Sset _t'14
                              (Efield
                                (Ederef
                                  (Etempvar _gc_funs (tptr (Tstruct __344 noattr)))
                                  (Tstruct __344 noattr))
                            ...
                            (Scall (Some _t'3)
                              ...
                              ((Etempvar _v (tptr (talignas 2%N (tptr tvoid)))) ::
                               nil)))
                          (Sset _hd (Etempvar _t'3 (tptr tuint))))
                        (Ssequence
                          (Ssequence
                            (Ssequence
                              (Sset _t'13
                              ...
                              (Ssequence
                                (Sset _t'11
                                  (Efield
                                    (Ederef
                                      (Etempvar _gc_funs (tptr (Tstruct __344 noattr)))
                                      (Tstruct __344 noattr)) _gc_block__copy
                                    (tptr (Tfunction
                                            (Tcons
                                              (tptr (talignas 2%N (tptr tvoid)))
                                              (Tcons
                                ...
                                (Ssequence
                                  ...
                                  (Sifthenelse (Ebinop Ogt
                                    ...
                                    (Ssequence
                                      (Sassign
                                        (Efield
                                          (Evar _f_args__1 (Tstruct __383 noattr))
                                          _gc_funs
                                          (tptr (Tstruct __344 noattr)))
                                        (Etempvar _gc_funs (tptr (Tstruct __344 noattr))))
                                      (Ssequence
                                        (Sassign
                                          (Efield
...
Definition f_forward_roots := {|
  fn_return := tvoid;
  fn_callconv := cc_default;
  fn_params := ((_gc_funs, (tptr (Tstruct __344 noattr))) ::
                (_from_start, (tptr (talignas 2%N (tptr tvoid)))) ::
                (_from_limit, (tptr (talignas 2%N (tptr tvoid)))) ::
                (_next, (tptr (tptr (talignas 2%N (tptr tvoid))))) ::
                (_fi, (tptr tuint)) ::
        ...
        (Sloop
          (Ssequence
            ...
            (Ssequence
              ...
              (Ssequence
                (Sassign
                  (Efield (Evar _f_args (Tstruct __383 noattr)) _from_start
                    (tptr (talignas 2%N (tptr tvoid))))
                  (Etempvar _from_start (tptr (talignas 2%N (tptr tvoid)))))
                (Ssequence
                  (Sassign
                    (Efield (Evar _f_args (Tstruct __383 noattr)) _from_limit
                      (tptr (talignas 2%N (tptr tvoid))))
                    (Etempvar _from_limit (tptr (talignas 2%N (tptr tvoid)))))
                  (Ssequence
                    (Sassign
                      (Efield (Evar _f_args (Tstruct __383 noattr)) _next
                        (tptr (tptr (talignas 2%N (tptr tvoid)))))
                      (Etempvar _next (tptr (tptr (talignas 2%N (tptr tvoid))))))
                    (Ssequence
                      (Sassign
                        (Efield (Evar _f_args (Tstruct __383 noattr)) _depth
                              ...
                              (Evar _forward (Tfunction
                                               (Tcons (tptr tvoid)
                                                 (Tcons
                                                   (tptr (talignas 2%N (tptr tvoid)))
                                                   Tnil)) tvoid cc_default))
                              ((Eaddrof (Evar _f_args (Tstruct __383 noattr))
                                 (tptr (Tstruct __383 noattr))) ::
                               (Etempvar _p (tptr (talignas 2%N (tptr tvoid)))) ::
                               nil))
                            Sskip)))))))))
                  ...
                  (Ssequence
                    (Sset _t'5
                      (Efield
                        ...
                        (tptr (talignas 2%N (tptr tvoid)))))
                    (Sassign
                      (Efield (Evar _f_args (Tstruct __383 noattr))
                        _from_limit (tptr (talignas 2%N (tptr tvoid))))
                      (Etempvar _t'5 (tptr (talignas 2%N (tptr tvoid))))))
                  (Ssequence
                    (Sassign
        ...
        (Ssequence
          (Ssequence
            (Ssequence
              (Sset _t'5
                (Efield
                  (Ederef (Etempvar _gc_funs (tptr (Tstruct __344 noattr)))
                    (Tstruct __344 noattr)) _gc_block__of_header
                  (tptr (Tfunction (Tcons (tptr tuint) Tnil)
                          (tptr (talignas 2%N (tptr tvoid))) cc_default))))
              (Scall (Some _t'1)
            ...
            (Ssequence
              (Ssequence
                (Sset _t'4
                  (Efield
                    (Ederef (Etempvar _gc_funs (tptr (Tstruct __344 noattr)))
                      (Tstruct __344 noattr)) _gc_block__size_get
                    (tptr (Tfunction (Tcons (tptr tuint) Tnil) tuint
                            cc_default))))
                (Scall (Some _t'2)
                  (Etempvar _t'4 (tptr (Tfunction (Tcons (tptr tuint) Tnil)
                                         tuint cc_default)))
                  ((Etempvar _hd (tptr tuint)) :: nil)))
              (Sset _sz (Etempvar _t'2 tuint)))
            (Ssequence
              (Sassign
                (Efield (Evar _f_args (Tstruct __383 noattr)) _gc_funs
                  (tptr (Tstruct __344 noattr)))
                        ...
                        (Ssequence
                          (Sset _t'3
                            (Efield
                              (Ederef
                                (Etempvar _gc_funs (tptr (Tstruct __344 noattr)))
                                (Tstruct __344 noattr)) _gc_block__ptr_iter
                              (tptr (Tfunction
                                      (Tcons
                                        (tptr (talignas 2%N (tptr tvoid)))
                                        (Tcons
      ...
      (Ssequence
        ...
        (Scall None
          (Evar _forward_roots (Tfunction
                                 (Tcons (tptr (Tstruct __344 noattr))
                                   (Tcons (tptr (talignas 2%N (tptr tvoid)))
                                     (Tcons
                                       (tptr (talignas 2%N (tptr tvoid)))
                                       (Tcons
...
Definition f_garbage_collect := {|
  ...
  fn_temps := ((_h, (tptr (Tstruct _heap noattr))) :: (_i, tint) ::
               (_w, tuint) :: (_t'10, (tptr (talignas 2%N (tptr tvoid)))) ::
               (_t'9, (tptr (talignas 2%N (tptr tvoid)))) ::
               (_t'8, (tptr (Tfunction (Tcons tint Tnil) tvoid cc_default))) ::
               (_t'7, (tptr (talignas 2%N (tptr tvoid)))) ::
               (_t'6, (tptr (Tfunction (Tcons tint Tnil) tvoid cc_default))) ::
               (_t'5, (tptr (talignas 2%N (tptr tvoid)))) ::
               (_t'4, (tptr (talignas 2%N (tptr tvoid)))) ::
               (_t'3, (tptr (talignas 2%N (tptr tvoid)))) ::
               (_t'2, (tptr (talignas 2%N (tptr tvoid)))) ::
                  ...
                  (Ssequence
                    (Sset _t'8
                      (Efield
                        (Ederef
                          (Etempvar _gc_funs (tptr (Tstruct __344 noattr)))
                          (Tstruct __344 noattr)) _gc_abort
                        (tptr (Tfunction (Tcons tint Tnil) tvoid cc_default))))
                    (Scall None
                      (Evar _create_space (Tfunction
                                            (Tcons
                                            ...
                                            cc_default))
                      ((Etempvar _t'8 (tptr (Tfunction (Tcons tint Tnil)
                                              tvoid cc_default))) ::
                       (Ebinop Oadd
                         (Efield
                           (Ederef
...
Definition f_remember := {|
  ...
  fn_temps := ((_t'1, (tptr (talignas 2%N (tptr tvoid)))) ::
               (_t'5, (tptr (talignas 2%N (tptr tvoid)))) ::
               (_t'4, (tptr (talignas 2%N (tptr tvoid)))) ::
               (_t'3, (tptr (Tstruct _heap noattr))) ::
  ...
  (Ssequence
    (Ssequence
      (Ssequence
        ...
        (Sset _t'1
          (Ecast
            (Ebinop Osub (Etempvar _t'5 (tptr (talignas 2%N (tptr tvoid))))
              (Econst_int (Int.repr 1) tint)
              (tptr (talignas 2%N (tptr tvoid))))
            (tptr (talignas 2%N (tptr tvoid))))))
      (Sassign
        ...
        (Sassign
          (Efield
            (Ederef
              (Ebinop Oadd
                (Efield
                  (Ederef (Etempvar _t'2 (tptr (Tstruct _heap noattr)))
                    (Tstruct _heap noattr)) _spaces
                  (tarray (Tstruct _space noattr) 12))
                (Econst_int (Int.repr 0) tint)
                (tptr (Tstruct _space noattr))) (Tstruct _space noattr))
            _limit (tptr (talignas 2%N (tptr tvoid))))
          (Ebinop Osub (Etempvar _t'4 (tptr (talignas 2%N (tptr tvoid))))
            (Econst_int (Int.repr 1) tint)
            (tptr (talignas 2%N (tptr tvoid)))))))))
|}.
...
(_free_heap :: _reset_heap :: _remember :: _garbage_collect :: _resume ::
 ...
 _do_scan :: _forward_remset :: _forward_roots :: _Is_block :: _forward ::
 _mark_as_forwarded :: _new_addr_from_forwarded :: _has_been_forwarded ::
 _Is_from :: _MAX_SPACE_SIZE :: _free :: _malloc :: _int_or_ptr__of_ptr ::
 _int_or_ptr__to_ptr :: _int_or_ptr__is_int :: ___builtin_debug ::
...
(*\nInput hashes (sha256):\n\nae956aee22b68484617a6df00523f4737d13b6c5bc2e7d8109027365deb942cb  src/c/include/coq-vsu-gc/src/gc.c
fc64eb3aa602d5fdefe115bc574b3c6f96ea3e7aed8fb2d6ddd63448f63bbfad  src/c/include/coq-vsu-gc/gc.h
