...
Definition __473 : ident := $"_473".
Definition __496 : ident := $"_496".
...
Definition f_certicoq_gc__num_allocs := {|
  ...
  fn_vars := nil;
  fn_temps := ((_rt, (tptr (Tstruct __496 noattr))) :: (_t'2, tulong) ::
               (_t'1, (tptr tulong)) :: nil);
  fn_body :=
(Ssequence
  (Sset _rt
    (Ecast (Etempvar _void_rt (tptr tvoid)) (tptr (Tstruct __496 noattr))))
  (Ssequence
    (Sset _t'1
      (Efield
        (Ederef (Etempvar _rt (tptr (Tstruct __496 noattr)))
          (Tstruct __496 noattr)) _fi (tptr tulong)))
    (Ssequence
      (Sset _t'2
        (Ederef
...
Definition f_certicoq_gc__resume := {|
  ...
  fn_vars := nil;
  fn_temps := ((_rt, (tptr (Tstruct __496 noattr))) ::
  ...
  (Ssequence
    (Ssequence
      (Sset _t'2
        (Efield
          (Ederef (Etempvar _rt (tptr (Tstruct __496 noattr)))
            (Tstruct __496 noattr)) _ti (tptr (Tstruct _thread_info noattr))))
      (Sassign
        (Efield
...
Definition f_certicoq_gc__root_ptr_iter := {|
  ...
  fn_temps := ((_rt, (tptr (Tstruct __496 noattr))) :: (_n, tulong) ::
               (_roots, (tptr tulong)) ::
...
Definition f_certicoq_gc__funs_init := {|
  fn_return := tvoid;
  fn_callconv := cc_default;
  fn_params := ((_out, (tptr (Tstruct __473 noattr))) :: nil);
  fn_vars := nil;
  fn_temps := nil;
  fn_body :=
(Ssequence
  (Sassign
    (Efield
      (Ederef (Etempvar _out (tptr (Tstruct __473 noattr)))
        (Tstruct __473 noattr)) _gc_abort
  ...
  (Ssequence
    (Sassign
      (Efield
        (Ederef (Etempvar _out (tptr (Tstruct __473 noattr)))
          (Tstruct __473 noattr)) _gc_block__header_get_ptr
    ...
    (Ssequence
      (Sassign
        (Efield
          (Ederef (Etempvar _out (tptr (Tstruct __473 noattr)))
            (Tstruct __473 noattr)) _gc_block__copy
          (tptr (Tfunction
      ...
      (Ssequence
        (Sassign
          (Efield
            (Ederef (Etempvar _out (tptr (Tstruct __473 noattr)))
              (Tstruct __473 noattr)) _gc_block__ptr_iter
            (tptr (Tfunction
                    (Tcons (tptr (talignas 3%N (tptr tvoid)))
                      (Tcons
                        (tptr (Tfunction
        ...
        (Ssequence
          (Sassign
            (Efield
              (Ederef (Etempvar _out (tptr (Tstruct __473 noattr)))
                (Tstruct __473 noattr)) _gc_block__of_base
              (tptr (Tfunction
                      (Tcons (tptr (talignas 3%N (tptr tvoid))) Tnil)
                      (tptr (talignas 3%N (tptr tvoid))) cc_default)))
            (Ecast
          ...
          (Ssequence
            (Sassign
              (Efield
                (Ederef (Etempvar _out (tptr (Tstruct __473 noattr)))
                  (Tstruct __473 noattr)) _gc_block__size_get
            ...
            (Ssequence
              (Sassign
                (Efield
                  (Ederef (Etempvar _out (tptr (Tstruct __473 noattr)))
                    (Tstruct __473 noattr)) _gc_rt__num_allocs
              ...
              (Ssequence
                (Sassign
                  (Efield
                    (Ederef (Etempvar _out (tptr (Tstruct __473 noattr)))
                      (Tstruct __473 noattr)) _gc_rt__resume
                    (tptr (Tfunction
                            (Tcons (tptr tvoid)
                              (Tcons (tptr (talignas 3%N (tptr tvoid)))
                                (Tcons (tptr (talignas 3%N (tptr tvoid)))
                ...
                (Sassign
                  (Efield
                    (Ederef (Etempvar _out (tptr (Tstruct __473 noattr)))
                      (Tstruct __473 noattr)) _gc_rt__root_ptr_iter
                    (tptr (Tfunction
                            (Tcons (tptr tvoid)
                              (Tcons
                                (tptr (Tfunction
...
Definition f_certicoq_gc__garbage_collect := {|
  ...
  fn_vars := ((_rt, (Tstruct __496 noattr)) ::
              (_gc_funs, (Tstruct __473 noattr)) :: nil);
  fn_temps := ((_t'1, (tptr (Tstruct _heap noattr))) :: nil);
  fn_body :=
(Ssequence
  (Sassign (Efield (Evar _rt (Tstruct __496 noattr)) _fi (tptr tulong))
    (Etempvar _fi (tptr tulong)))
  (Ssequence
    (Sassign
      (Efield (Evar _rt (Tstruct __496 noattr)) _ti
        (tptr (Tstruct _thread_info noattr)))
      (Etempvar _ti (tptr (Tstruct _thread_info noattr))))
    (Ssequence
      (Scall None
        (Evar _certicoq_gc__funs_init (Tfunction
                                        (Tcons (tptr (Tstruct __473 noattr))
                                          Tnil) tvoid cc_default))
        ((Eaddrof (Evar _gc_funs (Tstruct __473 noattr))
           (tptr (Tstruct __473 noattr))) :: nil))
      (Ssequence
        (Sset _t'1
          (Efield
            (Ederef (Etempvar _ti (tptr (Tstruct _thread_info noattr)))
                                   ...
                                   (Tcons (tptr (Tstruct __473 noattr))
                                     (Tcons (tptr tvoid)
                                       (Tcons (tptr (Tstruct _heap noattr))
                                         Tnil))) tvoid cc_default))
          ((Eaddrof (Evar _gc_funs (Tstruct __473 noattr))
             (tptr (Tstruct __473 noattr))) ::
           (Eaddrof (Evar _rt (Tstruct __496 noattr))
             (tptr (Tstruct __496 noattr))) ::
           (Etempvar _t'1 (tptr (Tstruct _heap noattr))) :: nil))))))
|}.

Definition composites : list composite_definition :=
(Composite __473 Struct
